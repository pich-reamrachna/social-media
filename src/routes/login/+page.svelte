<script lang="ts">
	let username = ''
	let password = ''
	let maintainSync = false
	let showPassword = false

	// placeholder for login stuff, will change later
	const handleSignIn = (e: Event) => {
		e.preventDefault()
		console.log('Authenticating:', { username, password, maintainSync })
	}
...
>
	...
	>
		<div>
			...
			<p class="max-w-xs text-[10px] leading-relaxed tracking-[0.2em] text-gray-500 uppercase">
	...
	>
		<div class="w-full max-w-md">
			<div class="mb-10">
				...
				<p class="text-sm text-gray-400">Access your Y profile.</p>
			</div>
